...
let TelemetryService = class TelemetryService {
    ...
    constructor(httpService, configService) {
        ...
        this.telemetryServiceUrl = this.configService.get('telemetryService.apiUrl') || 'http://localhost:3003';
    }
    async createTelemetry(telemetryData) {
        try {
            ...
            throw new Error(error.response?.data?.message || 'Failed to send telemetry to telemetry-service');
        }
    }
};
