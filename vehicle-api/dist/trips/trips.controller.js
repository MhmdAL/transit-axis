...
let TripsController = class TripsController {
    ...
    async startTrip(startTripDto, authHeader) {
        try {
            if (!authHeader) {
    ...
    async endTrip(tripId, authHeader) {
        try {
            ...
            throw new common_1.HttpException(error.message || 'Failed to end trip', common_1.HttpStatus.BAD_REQUEST);
        }
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [StartTripDto, String]),
